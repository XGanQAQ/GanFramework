...
namespace GanFramework.Editor.Modules.Settings.Providers
{
    public class DataSettingsProvider : SettingsProvider
    {
        ...
        {
            return new DataSettingsProvider("Project/Gan Framework/Data Pipeline", SettingsScope.Project)
            {
                keywords = new[] { "Gan", "Data", "Pipeline", "Excel", "Json", "Binary" }
            };
        }
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.LabelField(
                asset.CSharpUseExternal
                    ? "当前状态：生成的 C# 数据类将输出到 GanFramework_Data/DataClass 下。"
                    : "当前状态：生成的 C# 数据类将输出到 Assets/GanFramework_Data/DataClass 下。",
                FFEditorStyles.Description);
