...
namespace GanFramework.Editor.Modules.Settings.Providers
{
    public class EncryptionSettingsProvider : SettingsProvider
    {
        ...
        {
            return new EncryptionSettingsProvider("Project/Gan Framework/Encryption", SettingsScope.Project)
            {
                keywords = new[] { "Gan", "Encryption", "AES", "Security", "Password", "Data" }
            };
        }
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.LabelField(
                "框架生成的所有加密数据文件都会使用此后缀，例如：.gan、.dat、.bytes。",
                FFEditorStyles.Description);
