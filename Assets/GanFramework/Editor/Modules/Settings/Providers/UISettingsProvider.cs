...
using GanFramework.Core.Settings;
using GanFramework.Core.Settings.ScriptableObjects;
using GanFramework.Editor.Modules.Settings.Loaders;
using UnityEditor;
using UnityEngine;
...
namespace GanFramework.Editor.Modules.Settings.Providers
{
    public class UISettingsProvider : SettingsProvider
    {
        ...
        {
            return new UISettingsProvider("Project/Gan Framework/UI Settings", SettingsScope.Project)
            {
                keywords = new[] { "Gan", "Framework", "UI", "Settings", "Canvas" }
            };
        }
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            GUILayout.Space(6);
            asset.CurrentUIMode = (Core.Environments.EnvironmentState.UIMode)EditorGUILayout.EnumPopup("UI 渲染模式", asset.CurrentUIMode);
            EditorGUILayout.LabelField(
