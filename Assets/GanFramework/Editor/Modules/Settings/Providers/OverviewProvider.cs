...
namespace GanFramework.Editor.Modules.Settings.Providers
{
    public class OverviewProvider : SettingsProvider
    {
        ...
        public static SettingsProvider CreateProvider()
        {
            ...
            return new OverviewProvider("Project/Gan Framework", SettingsScope.Project)
            {
                keywords = new[] 
                { 
                    "Gan", "Framework", "Overview", "Settings",
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            // ===== Logo =====
            var logo = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/GanFramework/Editor/EditorResources/Icon/GanFramework_logo.png");
            ...
            FFEditorGUI.Center(() =>
            {
                GUILayout.Label("Gan Framework 项目配置", FFEditorStyles.Title);
            });
            ...
            EditorGUILayout.LabelField(
                "Gan Framework 是一个模块化 Unity 游戏框架，旨在提供：\n\n" +
            ...
            EditorGUILayout.LabelField($"Framework Version: {Core.Environments.EnvironmentState.FrameworkVersion}",
                FFEditorStyles.Description);
            ...
            EditorGUILayout.LabelField(
                "作者：Gankk\n" +
                "仓库：https://github.com/Gankk/GanFramework\n",
                FFEditorStyles.Description);
            ...
            FFEditorGUI.Center(() =>
            {
                GUILayout.Label("Copyright © 2025 Gan Framework", FFEditorStyles.Footer);
            });
        }
    }
}
