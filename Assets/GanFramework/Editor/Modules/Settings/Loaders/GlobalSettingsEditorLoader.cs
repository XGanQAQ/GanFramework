...
namespace GanFramework.Editor.Modules.Settings.Loaders
{
    ...
    public static class GlobalSettingsEditorLoader
    {
        ...
        /// 全局配置文件的存储路径
        /// </summary>
        public const string AssetPath = "Assets/GanFramework/Runtime/Resources/GanFramework/Settings/Global/GlobalSettingsAsset.asset";
        ...
        public static GlobalSettingsAsset LoadOrCreate()
        {
            ...
            if (asset == null)
            {
                ...
                LogUtil.Info("GanFramework", "已自动创建 GlobalSettingsAsset");
            }
