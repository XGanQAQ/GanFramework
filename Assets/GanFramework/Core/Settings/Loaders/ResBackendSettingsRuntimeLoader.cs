    ...
    public class ResBackendSettingsRuntimeLoader
    {
        ...
        public static AddressablesBackendSettingsAsset Addressables
        {
            get
            {
                ...
                if (global.ResourceBackend != GanFramework.Core.Environments.EnvironmentState.ResourceBackendType.Addressables)
                    return null;
        ...
        public static AssetBundleBackendSettingsAsset AssetBundle
        {
            get
            {
                ...
                if (global.ResourceBackend != GanFramework.Core.Environments.EnvironmentState.ResourceBackendType.AssetBundle)
                    return null;
        ...
        public static bool TryGetCurrent(out ScriptableObject backendSettings)
        {
            ...
            {
                case GanFramework.Core.Environments.EnvironmentState.ResourceBackendType.AssetBundle:
                    backendSettings = global.AssetBundleSettings;
                    break;

                case GanFramework.Core.Environments.EnvironmentState.ResourceBackendType.Addressables:
