...
namespace GanFramework.Core.Utils
{
    /// <summary>
    /// 字符串工具类：拆分、数字/时间格式化等
    /// </summary>
    public static class TextsUtil
    {
        ...
        public static void SplitStrToIntArrTwice(string str, SplitType typeOne, SplitType typeTwo, Action<int, int> callBack)
        {
        ...
        /// <param name="typeTwo">键值对分隔符  1-; 2-, 3-% 4-: 5-空格 6-| 7-_ </param>
        /// <param name="callBack">回调函数</param>
        public static void SplitStrToStrArrTwice(string str, SplitType typeOne, SplitType typeTwo, Action<string, string> callBack)
        {
            string[] strs = SplitStrToStrArr(str, typeOne);
            if (strs.Length == 0)
                return;
